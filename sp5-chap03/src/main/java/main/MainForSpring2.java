...
public class MainForSpring2 {
	...
	//throws IOException: 입출력 처리시 예외가 발생하면 이 클레스를 벗어남. 입출력 사용 시 안쓰면 컴파일 에러남  
	...
	private static void processNewCommand(String[] arg) {
		...
		try {
			regSvc.regist(req); //여기서 중복 되도 에러 발생 안함 
	...
	private static void processChangeCommand(String[] arg) {
		...
		try {
			changePwdSvc.changePassword(arg[1], arg[2], arg[3]); //이메일, 구 비번, 신 비번 
